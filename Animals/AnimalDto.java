...
public class AnimalDto {
    ...
    public AnimalDto(int id, String name, String type, ArrayList<String> commands, String date) {
        setId(id);
        setName(name);
        setType(type);
    ...
    public AnimalDto(String name, String type, ArrayList<String> commands, String date) {
        setName(name);
        setType(type);
        setCommands(commands);
        setDate_of_birth(date);
